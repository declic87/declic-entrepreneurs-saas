            ...
            {RDV.map((r) => (
              <div
                ...
                className={`rounded-2xl p-6 border ${
                  r.premium
                    ? "bg-white/5 border-white/10 ring-1 ring-amber-400/40"
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 divide-y rounded-2xl border border-slate-200 bg-white">
            {[
              ...
              <details
                key={q}
                className="group open:bg-slate-50 px-6 py-4 transition-colors"
              >
                <summary className="flex cursor-pointer list-none items-center justify-between">
                  <span className="font-medium text-[#123055] text-lg">
                    {q}
                  </span>
                  <span className="transition-transform duration-300 text-slate-500 group-open:rotate-180">
                    ⌄
                  </span>
                </summary>

                <p className="mt-3 text-slate-600 leading-relaxed">
                  Réponse personnalisée selon votre situation. Réservez un
                  diagnostic gratuit pour obtenir un plan d’action adapté.
                </p>
              </details>
            ))}
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-4 gap-8 text-slate-200">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/simulateurs/comparateur" className="hover:text-white">
                    Comparateur statuts
                  </Link>
                </li>
                <li>
                  <Link href="/simulateurs/economies" className="hover:text-white">
                    Simulateur économies
                  </Link>
                </li>
                <li>
                  <Link href="/simulateurs/ik" className="hover:text-white">
                    Indemnités kilométriques
                  </Link>
                </li>
                <li>
                  <Link href="/simulateurs/immobilier" className="hover:text-white">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/formations/essentielle" className="hover:text-white">
                    Formation Essentielle
                  </Link>
                </li>
                <li>
                  <Link href="/formations/agent-immobilier" className="hover:text-white">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="mailto:contact@declic-entrepreneur.fr" className="hover:text-white">
                    contact@declic-entrepreneur.fr
                  </a>
                </li>
                <li>
