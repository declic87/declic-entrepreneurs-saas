...
const SIMULATEURS = [
  {
    ...
    subtitle: "Micro vs SASU vs EURL",
    icon: FileSpreadsheet,
    href: "/simulateurs/comparateur",
    color: "#3B82F6",
  },
  {
    title: "Simulateur d’Économies",
    subtitle: "Méthode VASE",
    icon: TrendingUp,
    href: "/simulateurs/economies",
    color: "#10B981",
  },
  {
    title: "Calculateur de Charges",
    subtitle: "Charges sociales et fiscales",
    icon: Receipt,
  ...
  },
  {
    ...
    subtitle: "LMNP, SCI IR, SCI IS",
    icon: Building2,
    href: "/simulateurs/immobilier",
    color: "#F59E0B",
  },
  {
    title: "Simulateur Dividendes",
    subtitle: "PFU 30% vs Barème",
    icon: Coins,
  ...
  },
  {
    ...
    subtitle: "Projection 12 mois",
    icon: Wallet,
    href: "/simulateurs/tresorerie",
    color: "#10B981",
  },
  {
    title: "Prévisionnel 3 ans",
    subtitle: "Business plan complet",
    icon: FileSpreadsheet,
    href: "/simulateurs/previsionnel",
    color: "#8B5CF6",
  },
];
...
const BENEFITS = [
  {
    title: "Déduire vos frais",
    desc: "IK, bureau, repas, matériel… Tout devient déductible.",
    color: "bg-emerald-50 text-emerald-700",
    icon: PiggyBank,
  },
  {
    title: "Protéger votre patrimoine",
    desc: "Responsabilité limitée. Vos biens personnels sont protégés.",
    color: "bg-blue-50 text-blue-700",
    icon: Shield,
  },
  {
    title: "Accéder aux financements",
    desc: "Bilans, crédibilité bancaire, accès aux prêts pro.",
    color: "bg-violet-50 text-violet-700",
    icon: TrendingUp,
  },
  {
    title: "Gagner en crédibilité",
    desc: "Grands comptes, image pro, contrats plus sérieux.",
...
const FORMATIONS = [
  {
    ...
    cta: "/formations/essentielle",
  },
  {
    name: "Formation Agent Immobilier",
    price: "897€",
    bullets: [
      "Optimisation spécifique immobilier",
      "Régime fiscal optimal",
      "Frais réels vs micro",
      "Stratégies avancées",
    ],
    highlighted: true,
    cta: "/formations/agent-immobilier",
  },
];
...
const RDV = [
  {
    ...
    cta: "https://calendly.com/declic-entrepreneurs/diagnostic",
  },
  {
...
const OFFRES = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "5 RDV de suivi",
      "1er Audit annuel inclus",
      "Support illimité 12 mois",
    ],
...
function SectionTitle({
  ...
  return (
    <div className={center ? "text-center" : ""}>
      {eyebrow ? (
        <p className="text-sm font-medium text-slate-500 mb-2">{eyebrow}</p>
      ) : null}
      <h2 className="text-3xl md:text-4xl font-extrabold text-[#2C3E50] tracking-tight">
        {title}
      </h2>
      {subtitle ? (
        <p className="text-lg text-slate-600 mt-2 max-w-2xl mx-auto">{subtitle}</p>
      ) : null}
    </div>
  );
}
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      {/* NAVBAR */}
      <nav className="fixed top-0 z-50 w-full bg-[#123055]/95 backdrop-blur border-b border-white/10">
        ...
        {/* Mobile */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-white/10 bg-[#0F2742]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-center font-extrabold leading-tight tracking-tight text-4xl md:text-6xl">
            ...
            <span className="block text-[#F59E0B]">
              Optimisez, déduisez, gagnez plus
            </span>
          </h1>
          <p className="text-center text-lg md:text-xl text-slate-200 mt-6 max-w-3xl mx-auto">
            Passez de micro‑entrepreneur à chef d’entreprise. Nos experts vous
            accompagnent de A à Z pour maximiser vos revenus nets.
          </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {SIMULATEURS.map((s) => (
              <Link key={s.title} href={s.href}>
                <div className="group rounded-2xl bg-white border border-slate-200 hover:border-[#F59E0B]/60 shadow-sm hover:shadow-lg transition-all p-6">
                  <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {BENEFITS.map((b) => (
              ...
              >
                <div className={`mx-auto w-12 h-12 rounded-lg flex items-center justify-center ${b.color} mb-3`}>
                  <b.icon size={22} />
                </div>
            ...
            {FORMATIONS.map((f) => (
              <div
                ...
                className={`rounded-2xl border p-6 bg-white shadow-sm ${
                  f.highlighted ? "border-amber-300" : "border-slate-200"
                }`}
              >
      ...
      {/* RDV STRATÉGIQUES */}
      <section id="rdv" className="py-16 bg-[linear-gradient(180deg,#0f2742_0%,#0f2742_60%,#102b48_100%)] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 rounded-2xl border border-amber-200 bg-amber-50/60 p-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <p className="text-xl font-extrabold">97€<span className="text-sm font-semibold">/mois</span></p>
              ...
              <div
                ...
                className={`rounded-2xl p-6 border shadow-sm ${
                  o.dark
                    ...
                    : "bg-white text-[#123055] border-slate-200"
                ...
                <Link href={o.cta}>
                  <Button
                    className={`mt-6 rounded-xl ${
                      o.dark
                        ? "bg-white text-[#123055] hover:bg-slate-100"
            ...
            {[
              {
                ...
                quote:
                  "Grâce à l’accompagnement, j’économise plus de 12 000€ par an. Le passage en SASU a tout changé !",
              },
              {
                name: "Thomas R.",
                role: "Développeur Freelance",
                quote:
                  "Je ne comprenais rien à la fiscalité. L’équipe m’a tout expliqué clairement et simplement.",
              },
              {
                name: "Marie L.",
                role: "Agent Immobilier",
                quote:
                  "La formation agent immobilier m’a permis de récupérer 8 000€ d’impôts. Incroyable !",
              },
            ].map((t) => (
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 divide-y rounded-2xl border border-slate-200 bg-white">
            {[
              ...
              <details key={q} className="group open:bg-slate-50 px-6 py-4">
                <summary className="flex cursor-pointer list-none items-center justify-between">
                  <span className="font-medium text-[#123055]">{q}</span>
                  <span className="transition-transform group-open:rotate-180 text-slate-500">⌄</span>
                </summary>
                <p className="mt-3 text-slate-600">
                  Réponse personnalisée selon votre situation. Réservez un diagnostic gratuit pour obtenir
