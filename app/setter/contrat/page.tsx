...
export default function SetterContratPage() {
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Contrat de prestation setter</p>
        </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span className="font-semibold text-gray-900">Contrat Prestataire Setter</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-gray-100">
